 ...
 * ======================
 * Builds projects.html from window.PORTFOLIO.projects: a short intro followed
 * by one section per project, each with a text write-up and a media gallery
 * (images, hosted videos, or embedded videos). Mirrors the research page.
 */
(function () {
  "use strict";
  ...
  function tableOfContents(projects) {
    ...
    var links = projects
      ...
      .join("");
    return '<nav class="projects-toc" aria-label="Projects">' + links + "</nav>";
  }
  ...
  function renderProjectsPage() {
    ...
    var data = (window.PORTFOLIO || {}).projects;
    if (!data) {
      root.innerHTML =
        '<section class="container projects-hero"><h1>Projects</h1>' +
        "<p>No projects added yet.</p></section>";
      return;
    }
  ...
  window.Portfolio.renderProjectsPage = renderProjectsPage;
})();
